...
{      String characteristics, type,evolution,baseExp;
	         ...
	         {
	        	 super("Dragonite",149);
	     		this.characteristics="Dragonite is capable of flying faster than the speed of sound. It is a kindhearted Pok̩mon with human-like intelligence. It shows signs of altruism.";
	     		this.type="poison";
