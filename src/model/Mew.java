...
{      String characteristics, type,evolution,baseExp;
	         ...
	         {
	        	 super("Mew",151);
	     		this.characteristics="Mew is a Psychic-type Mythical Pok̩mon introduced in Generation I. Mew is notable for its unique ability to learn every Technical Machine, Technical Record & Hidden Machine.";
	     		this.type="PSYCHIC";
	     		this.evolution = "NONE";
	     		this.baseExp = "64";
	         }
